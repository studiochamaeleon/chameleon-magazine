...
export const articleType = defineType({
  ...
  fields: [
    ...
    defineField({
      name: 'seoTitle',
      title: 'SEO Title',
      description: '검색 결과에 사용할 제목입니다. 비워두면 기사 제목이 사용됩니다.',
      type: 'string',
    ...
    defineField({
      ...
      description: '검색 결과 설명문입니다. 비워두면 Excerpt가 사용됩니다.',
      type: 'text',
      rows: 2,
    ...
    defineField({
      name: 'seoKeywords',
      title: 'SEO Keywords',
      description: '검색 의도와 관련된 아티스트명, 곡명, 장르, 이슈 키워드를 입력하세요.',
      type: 'array',
    ...
    defineField({
      ...
      description: '검색/공유 미리보기용 이미지입니다. 비워두면 커버 이미지가 사용됩니다.',
      type: 'image',
    ...
    defineField({
      name: 'canonicalUrl',
      title: 'Canonical URL',
      description: '원문이 따로 있는 경우에만 입력하세요. 일반 기사에서는 비워두면 됩니다.',
      type: 'url',
    }),
    defineField({
      name: 'category',
